...
def main():
    window = Tk()
    window.title("European Derbies Data")
...
def epl():
    ...
    buttMan = Button(window, text = "Manchester Derby", bg = "white", command = lambda: parse("MAN UTD", "MAN CITY", "EPL"))
    buttLon = Button(window, text = "London Derby", bg = "white", command = lambda: parse("ARSENAL", "CHELSEA", "EPL"))
    buttNor = Button(window, text = "North London Derby", bg = "white", command = lambda: parse("TOTTENHAM", "ARSENAL", "EPL"))
    buttWes = Button(window, text = "West London Derby", bg = "white", command = lambda: parse("CHELSEA", "FULHAM", "EPL"))
    buttMer = Button(window, text = "Merseyside Derby", bg = "white", command = lambda: parse("LIVERPOOL", "EVERTON", "EPL"))
    buttTyn = Button(window, text = "Tyne-Wear Derby", bg = "white", command = lambda: parse("SUNDERLAND", "NEWCASTLE", "EPL"))
...
def parse(derby1, derby2, league):
    pos1 = []
    pos2 = []
    total = 0
    total2 = 0
